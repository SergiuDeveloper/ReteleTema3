...
--
-- Table structure for table `AdministratorAccounts`
--

DROP TABLE IF EXISTS `AdministratorAccounts`;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sys`.`AdministratorAccounts_BEFORE_INSERT` BEFORE INSERT ON `AdministratorAccounts` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `sys`.`AdministratorAccounts_BEFORE_UPDATE` BEFORE UPDATE ON `AdministratorAccounts` FOR EACH ROW
BEGIN
	IF NEW.Name REGEXP '^[A-Za-z0-9]+$' = FALSE THEN
		SIGNAL SQLSTATE '45000' SET MESSAGE_TEXT = 'The Name field in the AdministratorAccounts table can only contain alphanumeric characters';
	END IF;
...
--
-- Table structure for table `ClientIPsWhitelist`
--

DROP TABLE IF EXISTS `ClientIPsWhitelist`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ClientIPsWhitelist` (
  `ID` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `ClientIP` varchar(16) NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idClientIPsWhitelist_UNIQUE` (`ID`),
  UNIQUE KEY `ClientIP_UNIQUE` (`ClientIP`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ClientMACs`
--

DROP TABLE IF EXISTS `ClientMACs`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `ClientMACs` (
  ...
  CONSTRAINT `ClientMAC_ClientIP` FOREIGN KEY (`ClientIPID`) REFERENCES `ClientIPsWhitelist` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `EnvironmentVariables`
--

DROP TABLE IF EXISTS `EnvironmentVariables`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `EnvironmentVariables` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `idEnvironmentVariables_UNIQUE` (`ID`),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetLocalServerPath`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GetMACsForWhitelistedIP` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GetMACsForWhitelistedIP`(clientIP VARCHAR(16))
BEGIN
	SELECT ClientMAC FROM ClientIPsWhitelist
		JOIN ClientMACs ON ClientMACs.ClientIPID = ClientIPsWhitelist.ID
		WHERE ClientIPsWhitelist.ClientIP = clientIP;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_IsWhitelistedIP` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_IsWhitelistedIP`(clientIP VARCHAR(16))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_LogLocalServerPath` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
-- Dump completed on 2019-12-12 12:27:03
